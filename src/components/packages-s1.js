...
class PackagesS1 extends Component{
    render(){
        return(    
            <Container fluid className="packages-s1 bg-dark d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
