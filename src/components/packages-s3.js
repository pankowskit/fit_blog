...
class PackagesS3 extends Component{
    render(){
        return(    
            <Container fluid className="packages-s3 d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
